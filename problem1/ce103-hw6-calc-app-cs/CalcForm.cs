...
namespace LesGraphingCalc
{
    public partial class CalcForm : Form
    {
        ...
        static List<LNode> ParseExprs(string fieldName, string text)
        {
            ...
            var errorHandler = MessageSink.FromDelegate((severity, ctx, fmt, args) => {
                if (severity >= Severity.Error) {
                    ...
                    throw new calculator.LogException(severity, ctx, msg);
                }
            });
        ...
        private void cbRanges_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        private void button41_Click(object sender, EventArgs e)
        {
            ...
            private void lblMouseOver_Click(object sender, EventArgs e)
            {
                textBox1.Text += button40.Text;
            }
